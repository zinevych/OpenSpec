...
describe('tool-detection', () => {
  ...
  describe('SKILL_NAMES', () => {
    it('should contain all skill names matching COMMAND_IDS', () => {
      ...
      expect(SKILL_NAMES).toContain('flow-studio-explore');
      expect(SKILL_NAMES).toContain('flow-studio-new-change');
      expect(SKILL_NAMES).toContain('flow-studio-continue-change');
      expect(SKILL_NAMES).toContain('flow-studio-apply-change');
      expect(SKILL_NAMES).toContain('flow-studio-ff-change');
      expect(SKILL_NAMES).toContain('flow-studio-sync-specs');
      expect(SKILL_NAMES).toContain('flow-studio-archive-change');
      expect(SKILL_NAMES).toContain('flow-studio-bulk-archive-change');
      expect(SKILL_NAMES).toContain('flow-studio-verify-change');
      expect(SKILL_NAMES).toContain('flow-studio-onboard');
      expect(SKILL_NAMES).toContain('flow-studio-propose');
    });
  });
  ...
  describe('getToolSkillStatus', () => {
    ...
    it('should detect when one skill exists', async () => {
      const skillDir = path.join(testDir, '.claude', 'skills', 'flow-studio-explore');
