...
function getWelcomeText(): string[] {
  return [
    chalk.white.bold('Welcome to Flow Studio'),
    chalk.dim('A lightweight spec-driven framework'),
    '',
    chalk.white('This setup will configure:'),
    chalk.dim('  • Agent Skills for AI tools'),
    chalk.dim('  • /fwst:* slash commands'),
    '',
    chalk.white('Quick start after setup:'),
    `  ${chalk.yellow('/fwst:new')}      ${chalk.dim('Create a change')}`,
    `  ${chalk.yellow('/fwst:continue')} ${chalk.dim('Next artifact')}`,
    `  ${chalk.yellow('/fwst:apply')}    ${chalk.dim('Implement tasks')}`,
    '',
