...
export function getProjectSchemasDir(projectRoot: string): string {
  return path.join(projectRoot, 'flow-studio', 'schemas');
}
 ...
 * 1. Project-local: <projectRoot>/flow-studio/schemas/<name>/schema.yaml
 * 2. User override: ${XDG_DATA_HOME}/flow-studio/schemas/<name>/schema.yaml
